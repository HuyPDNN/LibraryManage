...
{
    public abstract class LabraryManageWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LabraryManageWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LabraryManageWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LabraryManageDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LabraryManageDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LabraryManageDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LabraryManageDbContext, Task<T>> func)
        {
            T result;
