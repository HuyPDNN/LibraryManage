...
namespace LabraryManage.Migrations
{
    public partial class newdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.Authors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.Categories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.Provinces", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.Publishers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.Districts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abp.Books", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Abp.BorrowBookDetails_Abp.Libraries_LibraryId",
                        column: x => x.LibraryId,
                        principalTable: "Abp.Libraries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Abp.FavoriteBooks_Abp.Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Abp.Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Abp.FavoriteBooks_Abp.Libraries_LibraryId",
                        column: x => x.LibraryId,
                        principalTable: "Abp.Libraries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Abp.BorrowBookDetails_LibraryId",
                table: "Abp.BorrowBookDetails",
                column: "LibraryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Abp.FavoriteBooks_BookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Abp.FavoriteBooks_LibraryId",
                table: "Abp.FavoriteBooks",
                column: "LibraryId");
